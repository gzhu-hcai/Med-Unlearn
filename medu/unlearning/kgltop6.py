...
class KGLTop6(BaseUnlearner):
    ...
    HYPER_PARAMETERS = {
        ...
        "unlearner.cfg.retain_num_epochs": medu.settings.HP_NUM_EPOCHS,
        "unlearner.cfg.retain_optimizer.learning_rate": medu.settings.HP_LEARNING_RATE,
        "unlearner.cfg.retain_optimizer.momentum": medu.settings.HP_MOMENTUM,
        "unlearner.cfg.retain_optimizer.weight_decay": medu.settings.HP_WEIGHT_DECAY,
