...
from medu.datasets import get_discernible_retain_and_forget_loaders
from medu.models import get_optimizer_scheduler_criterion
from medu.unlearning.common import BaseUnlearner
from medu.unlearning.salun import RandomRelabel
...
class SuccessiveRandomLabels(BaseUnlearner):
    HYPER_PARAMETERS = medu.settings.HYPER_PARAMETERS
