...
import medu.settings as settings
from medu.datasets import RandomRelabelDataset
...
class SaliencyUnlearning(BaseUnlearner):
    ...
    HYPER_PARAMETERS = {
        **settings.HYPER_PARAMETERS,
        "unlearner.cfg.threshold": medu.settings.HP_FLOAT,
        "unlearner.cfg.mask_optimizer.learning_rate": medu.settings.HP_LEARNING_RATE,
        "unlearner.cfg.mask_optimizer.momentum": medu.settings.HP_MOMENTUM,
        "unlearner.cfg.mask_optimizer.weight_decay": medu.settings.HP_WEIGHT_DECAY,
    }
