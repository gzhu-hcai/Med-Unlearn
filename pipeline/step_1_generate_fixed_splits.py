...
from medu import DEFAULT_FORGET_RATIO, DEFAULT_VAL_RATIO, FIXED_SPLITS_PATH
from medu.configurations import DatasetConfig
from medu.datasets import get_dataset_and_lengths
from medu.datasets.splits import generate_splits_indices, save_split
from medu.settings import DEFAULT_RANDOM_STATE
from medu.utils import DataSplit, setup_seed

logger = logging.getLogger(__name__)

store(
    make_config(
        hydra_defaults=["_self_", {"dataset": "isic"}],
        dataset=None,
